...
const Home = () => {
  ...
  return (
    <>
    <Helmet>
      <title>GoMovies - Stream Movies & TV Shows Online | GoMovies</title>
      <meta name="description" content="Discover the latest popular movies from TMDB." />
      <meta property="og:title" content="GoMovies - Stream Movies & TV Shows Online" />
      <meta property="og:description" content="Discover and stream the latest movies and TV shows on GoMovies. Enjoy a wide selection of genres and top-rated content." />
      <meta property="og:image" content={featuredItem?.poster_path ? `https://image.tmdb.org/t/p/w300${featuredItem.poster_path}` : 'https://placehold.co/500x750/000000/FFFFFF/png?text=No+Image'} />
